...
/*#__PURE__*/
function () {
  function _default(oldOfficer, newOfficer, items) {
...
function (_Slider) {
  ...
  function SliderMain(btns) {
    _classCallCheck(this, SliderMain);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMain).call(this, btns));
  }
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener("click", function () {
        ...
        while (_this2.slides[0].tagName === "BUTTON") {
          active = _this2.slides[_this2.slides.length - 1];
